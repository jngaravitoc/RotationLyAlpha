...
This shows that $F(\mu)$ is consistent with being flat, apart
...
integrated flux is the same for all viewing angles in the
...
is identical from a static one. 
...
it is necessary to consider the possible effect of rotation and different
...
rotation axis. This highlights the importance of considering rotation
in the interpretation of systemic velocity observations. 
