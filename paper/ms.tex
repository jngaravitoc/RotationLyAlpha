...
the full width at half maximum (FWHM) and the location of the peak maxima. In order to interpret the morphological changes in the line we also report the
...
\begin{figure*}
    \includegraphics[width=1.0\textwidth]{f2.eps}
...
to know to what extent the new velocity width can be expressed as a
quadratic sum of the two relevant velocities in the problem. By
fitting simultaneously all the data points corresponding to central
and homogeneous models we find $\lambda_{\rm c} = 3.9 \pm$ and
$\lambda_{\rm h}= 1.9\pm $ respectively.  
...
\begin{figure}
  \includegraphics[scale=0.4]{f7.eps}
...
\begin{figure}
\begin{center}
  \includegraphics[scale=0.4]{f8.eps}
...
\begin{figure}
  \includegraphics[scale=0.4]{f9.eps}
