...
{\bf Figure \ref{fig:3p_res} show that even with a low resolution a three-peak profile 
would be observed, this is important for observational porpoises due to the finite 
spectral resolution. Seguro? Que es baja resolucion y que es alta
resolucion en este contexto?}
