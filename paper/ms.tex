...
the gas. We select photons emitted in spheres that are off-centered
...
direction, such that the emitting sphere centered on $+C\hat{\i}$ moves away
from the observer and the sphere centered on $+C\hat{\i}$ moves towards
