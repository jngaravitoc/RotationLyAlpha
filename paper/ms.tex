...
have to possible centers positions $C$ along the $\hat{\i}$ direction:
$\pm C\hat{\i}$. We also place an observer along the $\hat{\j}$
direction, such that the emitting sphere centered on $+C\hat{\i}$ moves
away from the observer and the sphere centered on $+C\hat{\i}$ moves
