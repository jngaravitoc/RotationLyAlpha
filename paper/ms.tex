...
at rotational velocities larger than half the line width in the static
case. We also find that this anisotripic velocity configuration does
not induce any significant anisotropy in the spectral properties.
For radiation sources located off-center, the line morphology
presents  a range of single, double and triple peaks. We show how
these results  are useful to interpret recent spectroscopic results of distant 
...
\hat{k}_{\rm \hat{k}}$, that is the angle of the line of sight with
respect to the direction of the angular velocity. Following the notation
implemented in \cite{Zheng2013}. %we make the study of the anisotropic emission in
%terms of this angle. 
...
\begin{figure*}
\begin{center}
  \includegraphics[width=0.8\textwidth]{spectraCentral.eps}
\end{center}
\caption{Central.
...
\begin{figure*}
\begin{center}
  \includegraphics[width=0.8\textwidth]{spectraHOM.eps}
\end{center}
\caption{Homogeneous
    \label{fig:HOMSpec}}  
\end{figure*}
...
This profiles were obtained integrating the flux of photons 
 over the angle $\theta = \pi/2$, this means we made histograms of the 
 numbers of photons escaping the galaxy with a given frequency
