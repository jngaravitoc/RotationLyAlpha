...
We measure the peak maxima poisition to quantify the transition from
...
parallel to the rotationa axis ($\mu\sim 1.0$) the maxima of all
...
velocities in the case of homogenous source distributions. For instance, for
...
For the homogeneous static sphere we find that $\langle N_{\rm
  scatt}\rangle= (0.99, 0.59, 0.51)\tau_{\rm   H}$, thisrepresents
