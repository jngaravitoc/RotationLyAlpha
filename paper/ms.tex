...
\begin{figure*}
\begin{center}
  \includegraphics[width=0.48\textwidth]{vary_vel.pdf}
  \includegraphics[width=0.48\textwidth]{vary_angle.pdf}
\end{center}
\caption{
Comparison of the Monte Carlo results agains the analytic solution.
