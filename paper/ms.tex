...
We consider cases of a single central \lya source, and a uniform
...
For lines of sight perpendicular to the rotation axis the intensity at the line
center and the line width increase with rotational velocity.   
Along the same sight, the line becomes single peaked  at rotational
...
anisotropy in the integrated line flux nor in the escape fraction. 
We provide an analytical expression for the outgoing line intensity
that accounts for the velocity and viewing angle trends reported here.
\end{abstract}
...
frequency in the restframe of the gas and the direction of propagation
