...
We consider two types of source distributions: single central and a
homogeneoulsy distributed in the sphere. 
...
We provide an analytical expression for the outgoing \lya spectrum of
a rotating cloud which accounts for the velocity and viewing angle
...
Ee parametrize the dependency of the line width with  $V_{\rm max}$ as
%
\begin{equation}
...
In the frame of the rotating gas cloud, all atoms are stationary w.r.t
each other, an the scattering process proceeds identical as in the static
case\footnote{An alternative - more quantitative way - to view this is
  ...
  assumed rotation velocity of the cloud.}. 
This explains why the escape fraction of Ly$\alpha$ photon is
independent of the rotation velocity off the cloud.
...
spectra.
The area under the spectra is the same in all cases. 
...
to the axis of rotation ($\mu=0$ in the notation of the main body of
the paper, $i=0$ in the scheme of Fig~\ref{fig:scheme}). 
