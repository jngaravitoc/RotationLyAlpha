...
weak anisotropy at the level of $\Delta\mu\leq 3\%$. On the other hand the variations
...
As mentioned in \S \ref{sec:off-center} Off-centered emission shows signs of three peak 
...
In \S \ref{sec:widthpeak} For typical column densities of $N_{HI}=1^{19}-1^{20}$, 
