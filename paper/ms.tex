...
We use the full width at half maximum (FWHM), $W_{1/2}$to quantify the line
broadening. Figure \ref{fig:widthvsvelocity} shows how $W_{1/2}$ increases
with rotational velocity. {\bf Here we need to check the numbers to
  say something more specific.}


We parameterize the dependency of the linewidth as $W_{1/2}^2 =
W_{1/2,0}^2 + V_{\rm max}^2/\lambda^2$, where $W_{1/2,0}$ is the
