...
\begin{figure}
    \includegraphics[scale=0.35]{f3.eps}
...
broadening. Figure \ref{fig:widthvsvelocity} shows how $FWHM$ increases
...
\begin{equation}
 FWHM^2 = FWHM_{0}^2 + V_{\rm max}^2/\lambda^2,
\label{eq:fwhm}
\end{equation}
%
where $FWHM_{0}$ is the
...
1.9\pm 3.07\times 10^{-10}$ respectively.   
...
\begin{figure}
    \includegraphics[scale=0.35]{f4.eps}
...
\begin{figure*}
\begin{center}
  \includegraphics[scale=0.35]{f5_1.eps}
  \includegraphics[scale=0.35]{f5_2.eps}
  \includegraphics[scale=0.35]{f5_3.eps}
  \includegraphics[scale=0.35]{f5_4.eps}    
\end{center}
...
\begin{tabular}{c c}
\hline \hline
Model, $\tau_{H}$ & $\ V_{max}(km\ s^{-1})$ $0, 50, 100, 200, 300$ \\
\hline \hline
Homogeneous $10^{5}$& $\ 0.2637\  0.2661\  0.3091\  0.3570\  0.3709$ \\
Homogeneous $10^{6}$ & $\ 0.2894\  0.2891\  0.3096\  0.3607\  0.3937$ \\
Homogeneous $10^{7}$ &$\ 0.2279\  0.2298\  0.2318\  0.2547\  0.2813 $\\
Central $10^{5}$ & $\ 0.0966\  0.0966\  0.0965\  0.0965\  0.0965$ \\
Central $10^{6}$ & $\ 0.0663\  0.0665\  0.0665\  0.0665\  0.0665$ \\
Central $10^{7}$ & $\ 0.0149\  0.0158\  0.0158\  0.0158\  0.0158$ \\
\hline
\end{tabular}
\caption{
 Escape fraction values for all of the models. } 
\label{table:escape}
\end{center}
\end{table}
...
\begin{figure*}
\begin{center}
  \includegraphics[scale=0.35]{f6.eps}
...
In the right pnael of Figure \ref{fig:efvsv} we put these results in the context of
...
\begin{figure*}
\begin{center}
\includegraphics[scale=0.35]{f10.eps}
\end{center}
...
\begin{figure*}
\begin{center}
\includegraphics[scale=0.35]{f11.eps}
\end{center}
