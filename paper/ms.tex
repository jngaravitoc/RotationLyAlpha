...
models to find $\lambda_{\rm c} = 3.9 \pm$ and $\lambda_{\rm h}=
1.9\pm $ respectively.   
...
Central $10^{6}$ & $0.0663, 0.665, 0.0665, 0.0665, 0.665$ \\
...
\end{center}
  \caption{Effects of rotaation on the escape fraction. Left
