...
that a \ly photon will be found far from the center of the line. The
...
\citep{Adams72,Harrington73}. In our experiments we find  $\langle N_{\rm
  scatt}\rangle= (1.505, 1.002, 0.918)\tau_{\rm   H}$, for $\tau_{\rm H} = (10^{5}, 10^{6}, 10^{7})$ respectively. 
...
spheres this factor is $(1.510553, 1.002823, 0.9188793)$ for $\tau_{\rm H} = (10^{5}, 10^{6}, 10^{7})$ respectively. 
