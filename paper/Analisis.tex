...
We found that for the central distribution the escape fraction does
not depend in velocity neither in the angle of observation, while it
does in the optical depth, this result was already known from previous
works (references). On the other hand for the homogeneous distribution
we found that for higher velocities photons escape easily. The
difference between this two results is due to the fact that in the
...
rotation. This last argument also explain the fact that in the
homogeneous distribution the optical depth does not affects the escape
fraction . 
