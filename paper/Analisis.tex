...
Gas bulk rotation has a noticeable effect on the morphology of the \ly line. In
this section we discuss the observational implications of these
findings. 

We start by a quantitative discussion of the line morphology. Here we
follow  following a classification of $Ly\alpha$ profiles made by
...
red peak is stronger that in the blue, in Group II the blue peak is
stronger, in Group III there are single peaked profiles while while
Group IV containes multipeaked lines.

Neither Group I nor II can be explained by rotation. However, the
morphologies of the lines in Group III and IV are similar to some of
the results obtained in this paper.

Group III profiles are better represented by galaxies rotating at $V >
100 kms^{-1}$\\ 

Comparing with the sample of (Kulas et al) we observe that rotational effects could be 
associated in group IV and V in galaxies where the difference between the two peaks is 
small and .

An other interesting sample of LAEs was presented by (Yamada.T el al)
...
can be explained with the outflow model (Verhamme) due to the fact that 
...
No effects asociated with inflows or outflows 
