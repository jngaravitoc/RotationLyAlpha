...
\begin{center}
\includegraphics[width=0.6\textwidth]{../code/surface_mu_tau5_diff_pos.png}
\includegraphics[width=0.6\textwidth]{../code/surface_mu_tau7_diff_pos.png}
\end{center}

The distribution is also insensitive to the rotational velocity:

\begin{center}
\includegraphics[width=0.6\textwidth]{../code/surface_mu_t5_diff_v.png}
\end{center}
